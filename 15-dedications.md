...
Non-multiclass archetypes (Medic, Marshal, Sentinel, Eldritch Archer, Blessed One, etc.) are deferred to expansion. Each is a self-contained feat chain that can be added later without changing core rules.

High-priority candidates for first expansion: Medic, Marshal, Sentinel (most popular at tables).

## Open Design Work

- Verify all dedication features against our system changes (mana, conditions, etc.)
- Review PF2e's full archetype list and flag candidates for expansion
- Determine which generic archetypes are essential vs. nice-to-have
